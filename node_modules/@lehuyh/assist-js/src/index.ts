import type { Agreement, AgreementByMajor, Course, Group, School, Section, AssistMajorFetchOptions, AssistBaseFetchOptions, IGETCCourse, TransferArea } from './types.ts';
import { createAssistMajorURL, createAssistArticulationURL, createAssistArticulationURLFromKey, createAssistIGETCURL } from './utils.js';
